...
def CalcAreaPerMolecule(system):
    """ Calculates average area per lipid from apl.json file where area per lipid calculated by the calcAPL.py is stored. `system` should be the system dictionary. """
